...
import FsSocialMediaMarketing from 'app/components/firstScreens/FsSocialMediaMarketing';

import { SocialMediaMarketingFaqData } from 'components/layout/Footer-Components/FAQ-Data/SocialMediaMarketingFaqData';
...
export default function page() {
  return (
    <div>
      ...
      <SuccessStories />
      <RelatedBlogs />
      <FAQs pageTitle={'FAQ'} pageSubtitle={''} faqData={SocialMediaMarketingFaqData} />
      <Footer />
    </div>
  );
}
