...
import FsPrivateBlockchainDev from 'app/components/firstScreens/FsPrivateBlockchainDev';
import { industriesDataPvtBlockchain } from 'app/core/_data';
import { servicesParagraphsBlockChainDevelopment, titleParagraphsBlockChainDevelopment } from 'app/core/_data';

import { PrivateBlockchainDevFaqData } from 'components/layout/Footer-Components/FAQ-Data/PrivateBlockchainDevFaqData';
...
export default function page() {
  return (
    <div>
      ...
      />
      <ProcessWeFollow />
      <IndustriesWeServe data={industriesDataPvtBlockchain} />
      ...
      <FAQs
        ...
        faqData={PrivateBlockchainDevFaqData}
      />
      <Footer />
    </div>
  );
