...
import FsSmartContractsDev from 'app/components/firstScreens/FsSmartContractsDev';
import { servicesParagraphsBlockChainDevelopment, titleParagraphsBlockChainDevelopment } from 'app/core/_data';
import { industriesDataSmartContract } from 'app/core/_data';

import { SmartContractDevFaqData } from 'components/layout/Footer-Components/FAQ-Data/SmartContractDevFaqData';
...
export default function page() {
  return (
    <div>
      ...
      />
      <ProcessWeFollow />
      <IndustriesWeServe data={industriesDataSmartContract} />
      ...
      <FAQs
        ...
        faqData={SmartContractDevFaqData}
      />
      <Footer />
    </div>
  );
