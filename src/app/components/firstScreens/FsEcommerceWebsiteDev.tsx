...
export default function FsEcommerceWebsiteDev() {
  return (
    <div className=' w-full flex justify-between text-black pt-15 relative'>
      <div className=' w-[52%]   pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight -me-10'>
          <span className='text-primary'>E-Commerce</span> Website Development
        </h2>
      ...
      <div className='w-[42%] relative mr-20'>
        <Image
          fill
          src='/images/ecommercewebsitedevelopment.png'
