...
export default function FsContentWriting() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[56%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Content </span> Writing Services
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-11/12  '>
          Our expert content writer will deliver high quality content writing services that engage, inform and also
      ...
      <div className='w-[40%] relative'>
        <img src='/images/contentwritingservices.png' className=' absolute bottom-0' alt='' />
      </div>
