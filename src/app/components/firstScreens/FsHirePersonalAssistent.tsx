...
export default function FsHirePersonalAssistent() {
  return (
    <div className=' w-full flex justify-between text-black pt-15 relative'>
      <div className=' w-[56%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight  w-2/3'>
          Hire <span className='text-primary'> Personal Assistant</span>
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-11/12  '>
          Don&apos;t let daily tasks hold you back from achieving your goals. At IR Solutions, we connect you with
          exceptional Personal Assistants, ready to streamline your schedule and handle your tasks with expertise.
        </p>
      ...
      <div className='w-[40%] relative'>
        <img src='/images/hirepersonalassistent.png' className='' alt='' />
      </div>
