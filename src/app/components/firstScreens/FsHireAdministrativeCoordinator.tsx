...
export default function FsHireAdministrativeCoordinator() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[56%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          Hire<span className='text-primary'> Administrative Coordinator</span>
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-11/12  '>
          We have the best fit for your organization with highly skilled and experienced Administrative Coordinators.
          They&apos;ll help you keep your work running smoothly. Hire us today and let them become your right-hand
          person
        </p>
      ...
      <img src='/images/administrativecoordinator.png' className=' w-[40%]  flex justify-end' alt='' />
