...
export default function FsMagentoEcommerceDev() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[56%]   pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Magento</span> E-Commerce Development Services
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7  w-[91%]  '>
          We offer expert Magento development services to build powerful, scalable online stores. Boost your e-commerce
          with our custom solutions, seamless integrations, and optimised performance.
        </p>
      ...
      <img src='/images/magentoecommercedev.png' className=' w-[40%]  flex justify-end' alt='' />
