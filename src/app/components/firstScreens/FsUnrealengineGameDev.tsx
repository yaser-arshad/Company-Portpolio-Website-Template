...
export default function FsUnrealengineGameDev() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[56%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Unreal Engine</span> Game Development
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7  w-11/12  '>
          Elevate your projects with our advanced Unreal Engine game development services. Equipped with the most recent
          development tools, your projects will always thrive.
        </p>
      ...
      <img src='/images/unrealenginegamedev.png' className=' w-[40%]  flex justify-end' alt='' />
