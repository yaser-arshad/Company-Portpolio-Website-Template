...
export default function FsCscartDev() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[56%]     pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-[5rem]'>
          <span className='text-primary'>CS Cart</span> Development Services
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-[91%]  '>
          Get our expertise to crafting user-friendly designs, enabling multi-vendor support, integrating advanced
          management tools, optimizing with SEO, and offering extensive customization options.
        </p>
      ...
      <div className='w-[40%] relative'>
        <img src='/images/cscartdev.png' className=' absolute bottom-0' alt='' />
      </div>
