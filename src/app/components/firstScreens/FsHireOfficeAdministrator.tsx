...
export default function FsHireOfficeAdministrator() {
  return (
    <div className=' w-full flex justify-between text-black pt-15 relative'>
      <div className=' w-[56%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight w-91'>
          Hire <span className='text-primary'> Office Administrator</span>
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-11/12  '>
          IR Solutions provides the perfect solution for your team: multi-talented Office Assistants! They&apos;ll
          handle all the tasks you need completed, freeing you to focus on what matters most - growing your business!
          Hire us today!
        </p>
      ...
      <div className='w-[40%] relative'>
        <img
          src='/images/hireofficeadministrator.png'
          className=' absolute bottom-0 object-cover overflow-x-visible'
          alt=''
        />
      </div>
