...
export default function FsNodeWebDevServices() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[56%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Node JS</span> Web Development
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-[91%] '>
          We create adaptable and customized apps with NodeJs, ensuring backend development and database security. Our
          experts expedite the entire NodeJs development process.
        </p>
      ...
      <img src='/images/nodewebdev.png' className=' w-[40%]  flex justify-end' alt='' />
