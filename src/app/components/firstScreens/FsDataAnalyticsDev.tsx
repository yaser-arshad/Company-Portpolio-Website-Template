...
export default function FsDataAnalyticsDev() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[62%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          Transformative <span className='text-primary'>Data Analytics</span> Services
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-3/4  '>
          Our Data Analytics services empower organizations to harness the power of data, uncover valuable insights, and
      ...
      <div className='w-[38%] relative'>
        <Image
          fill
          src='/images/dataanalyticsdevservices.png'
          className='absolute -ms-20 object-cover overflow-x-visible'
          alt=''
        />
      </div>
