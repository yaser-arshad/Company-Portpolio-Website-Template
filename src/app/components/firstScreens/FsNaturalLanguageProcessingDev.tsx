...
export default function FsNaturalLanguageProcessingDev() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[58%]     pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Natural Language</span> Processing Solutions
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-11/12  '>
          Our Natural Language Processing services leverage AI to understand, interpret, and generate human language,
          revolutionizing communication and insights for businesses.
        </p>
      ...
      <img src='/images/nlpdevservices.png' className='  w-[40%]  flex justify-end' alt='' />
