...
export default function FsHireOfficeCoordinator() {
  return (
    <div className=' w-full flex justify-between text-black pt-15 relative'>
      <div className=' w-[56%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight w-91'>
          Hire <span className='text-primary'> Office Coordinator</span>
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-11/12  '>
          IR Solutions connects you with top-notch Office Coordinators. They will smoothly handle daily tasks and keep
          things running. Focus on what truly matters – growing your business. Hire us today!
        </p>
      ...
      <div className='w-[40%] relative'>
        <img src='/images/officecoordinator.png' className='' alt='' />
      </div>
