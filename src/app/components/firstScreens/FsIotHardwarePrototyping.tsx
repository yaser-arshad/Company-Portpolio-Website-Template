...
export default function FsIotHardwarePrototyping() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[56%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Iot Hardware</span> Prototyping Services
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-11/2  '>
          Our IoT hardware prototyping solutions bring concepts to life, enabling rapid development of smart, connected
          devices for the future of technology.
        </p>
      ...
      <img src='/images/iothardwareprototyping.png' className='   flex justify-end' alt='' />
