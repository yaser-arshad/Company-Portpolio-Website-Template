...
export default function FsVirtualRealityGameDev() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className='  w-[56%]     pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Virtual Reality</span> Game Development
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-11/12  '>
          IR Solutions is a pioneering VR game development firm. We offer bespoke 3D VR solutions, utilize the latest
          technologies, and deliver on time. Our skilled team crafts standout VR services. Contact us to join this
      ...
      <img src='/images/virtualrealitygamedev.png' className=' w-[40%]  flex justify-end' alt='' />
