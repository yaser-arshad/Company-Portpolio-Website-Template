...
export default function FsSmartContractsDev() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[56%]     pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Smart Contracts</span> Development Services
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-11/12  '>
          Embrace Efficiency with Smart Contracts! Our Smart Contracts development services offer you the key to secure,
          automated transactions. Choose us, your partner for seamless and trustworthy business operations.
        </p>
      ...
      <img src='/images/smartcontactdev.png' className=' w-[40%]  flex justify-end' alt='' />
