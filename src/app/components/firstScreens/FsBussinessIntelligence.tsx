...
export default function FsBussinessIntelligence() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[62%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Business Intelligence</span> Services
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-3/4  '>
          Our Business Intelligence solutions integrate data analytics, reporting, and visualization to deliver
          actionable insights, driving growth and efficiency across your organization.
        </p>
      ...
      <div className=' w-[38%] relative'>
        <img src='/images/bussinessintelligencedevservices.png' className='absolute bottom-0 right-10' alt='' />
      </div>
