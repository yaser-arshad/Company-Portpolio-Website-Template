...
export default function FsFlutterAppDevServices() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[58%] pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Flutter App</span> Development Services
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-3/4  '>
          Enhance your business operations by creating sophisticated Flutter apps. Optimize your business workflows by
          constructing advanced applications utilizing Flutter app development.
        </p>
      ...
      <div className='w-[40%] relative'>
        <img src='/images/flutterappdevservices.png' className='absolute bottom-0 right-10' alt='' />
      </div>
