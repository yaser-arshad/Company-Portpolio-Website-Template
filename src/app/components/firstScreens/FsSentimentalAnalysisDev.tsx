...
export default function FsSentimentalAnalysisDev() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[62%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Sentimental</span> Analysis Services
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-3/4  '>
          Our Sentiment Analysis services decode customer emotions from text, helping businesses understand and respond
          to feedback, improving customer satisfaction and loyalty.
        </p>
      ...
      <img src='/images/sentimentalanalysisdevservices.png' className=' w-[38%]  flex justify-end' alt='' />
