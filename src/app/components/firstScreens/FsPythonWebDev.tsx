...
export default function FsPythonWebDev() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[56%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Python</span> Web Development Services
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-[91%]  '>
          Our Python solutions power dozens of active projects. With our team ready in 2 weeks, we deliver quality
          software swiftly. Our decade of expertise makes us a top choice for Python services.
        </p>
      ...
      <img src='/images/phythonwebdev.png' className=' w-[40%]  flex justify-end' alt='' />
