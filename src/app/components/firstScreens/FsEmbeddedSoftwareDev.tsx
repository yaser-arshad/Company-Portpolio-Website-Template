...
export default function FsEmbeddedSoftwareDev() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[56%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Embedded Software</span> Development Services
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-11/12  '>
          Our Embedded Software Development solutions design and implement efficient, reliable software for embedded
          systems, ensuring optimal performance and functionality.
        </p>
      ...
      <div className='w-[40%] relative'>
        <Image fill src='/images/embeddedsoftwaredev.png' className='absolute object-cover overflow-x-visible' alt='' />
      </div>
