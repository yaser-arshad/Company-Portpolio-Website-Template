...
export default function FsObjectRecognitionDev() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className='  w-[56%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Object Recognition</span> Development Services
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-11/12 '>
          Our AI Developers unlocks the power of AI, our object recognition services deliver efficiency, and accuracy.
          Get a personalized solution from us with our expertise, cutting-edge technology, and cutting-edge technology.
          Let&apos;s elevate your business with precise object recognition!
        </p>
      ...
      <img src='/images/objectrecognitiondev.png' className=' w-[40%]  flex justify-end' alt='' />
