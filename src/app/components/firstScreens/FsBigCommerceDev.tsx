...
export default function FsBigCommerceDev() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[56%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Big-Commerce </span>Development Services
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-[91%]  '>
          Improve your online sales with IR Solutions Big-Commerce development services that create customized,
          scalable, and high-performing e-commerce stores specifically to your business needs.
        </p>
      ...
      <img src='/images/bigcommercedev.png' className='absolute bottom-0' alt='' />
      </div>
