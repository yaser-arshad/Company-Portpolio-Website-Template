...
export default function FsDevopsServices() {
  return (
    <div className=' w-full flex justify-between text-black pt-15 relative'>
      <div className=' w-[44%] pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Devops</span> Services
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7  '>
          IR Solutions, a DevOps provider, offers services for operational efficiency. Hire remote developers for
          quicker deployment, streamlined updates, and enhanced uptime, saving you time and money.
        </p>
      ...
      <div className=' w-[35%] relative mr-16'>
        <img src='/images/devopsservices.png' className='' alt='' />
      </div>
