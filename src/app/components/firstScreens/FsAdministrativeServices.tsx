...
export default function FsAdministrativeServices() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[56%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Administrative </span> Services
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-11/12  '>
          Our Administrative Services encompass human resources, legal support, facilities management, IT assistance,
          billing, collections, and executive management, providing a comprehensive suite of solutions.
        </p>
      ...
      <div className='relative w-[40%]'>
        <Image
          src='/images/administrativeservices.png'
          fill
          className='absolute object-cover overflow-x-visible'
          alt=''
        />
      </div>
