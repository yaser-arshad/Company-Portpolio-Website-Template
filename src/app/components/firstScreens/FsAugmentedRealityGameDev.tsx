...
export default function FsAugmentedRealityGameDev() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[56%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Augmented Reality</span> Game Development
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7  w-11/12   '>
          IR Solutions, a US-based AR game development leader, leverages AR&apos;s flexibility for various industries.
          Logic Simplified, with vast reality tech experience, creates top-performing AR games.
        </p>
      ...
      <img src='/images/augmentedrealitygamedev.png' className=' w-[40%]  flex justify-end' alt='' />
