...
export default function FsShopifyDev() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[56%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Shopify</span> Development Services
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-[91%] '>
          Our Shopify Development Services ensure your online store stands out with a seamless, user-friendly
          experience. With our expertise, your business can thrive in the competitive e-commerce landscape, driving
          sales and enhancing brand visibility.
        </p>
      ...
      <img src='/images/shopifydev.png' className=' w-[40%]  flex justify-end' alt='' />
