...
export default function FsDataForcastingServices() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[58%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight -me-20'>
          <span className='text-primary'>Data Forcasting</span> Solutions for Informed Decisions
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-11/12   '>
          Our advanced Data Forecasting services harness predictive analytics to anticipate trends, mitigate risks, and
          optimize strategies for a future-proofed business.
        </p>
      ...
      <div className='w-[40%] relative'>
        <img src='/images/dataforcastingdevservices.png' className='absolute bottom-0' alt='' />
      </div>
