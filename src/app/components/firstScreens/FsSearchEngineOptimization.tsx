...
export default function FsSearchEngineOptimization() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[58%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Search Engine Optimization </span> Services
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-11/12  '>
          IR Solutions offers tailored SEO services to boost your ranking, drive organic traffic, generate leads and
          sales. Our focus on tangible results makes us your ideal choice for effective internet SEO.
        </p>
      ...
      <img src='/images/searchengineoptimizations.png' className=' flex justify-end' alt='' />
