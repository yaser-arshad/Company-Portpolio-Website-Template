...
export default function FsConversationRateOptimisation() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[58%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight capitalize'>
          <span className='text-primary'>Conversion </span> Rate optimization Services
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-11/12  '>
          Let our conversion optimization team boost A/B testing, personalization, and data to supercharge your
      ...
      <div className='w-[40%] relative'>
        <img src='/images/conversationrateoptimize.png' className='absolute bottom-0' alt='' />
      </div>
