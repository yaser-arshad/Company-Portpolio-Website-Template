...
export default function FsPhpWebDevServices() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[56%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>PHP</span> Web Development Services
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-[91%] '>
          Hire remote developers that excel in PHP development, offering secure PHP web solutions including websites,
          portals, e-commerce, and more, leveraging a decade of experience.
        </p>
      ...
      <img src='/images/phpwebdev.png' className=' w-[40%]  flex justify-end' alt='' />
