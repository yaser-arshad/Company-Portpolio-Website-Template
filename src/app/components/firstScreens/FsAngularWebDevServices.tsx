...
export default function FsAngularWebDevServices() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[56%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Angular JS</span> Web Development
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-[91%]  '>
          Leveraging AngularJS, we transform your ideas into agile, scalable, high-performing apps. Partner with us, a
          leading AngularJS company, for dynamic web and mobile solutions.
        </p>
      ...
      <img src='/images/angularwebdev.png' className='absolute bottom-0' alt='' />
      </div>
