...
export default function FsHireAdministrativeManager() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[56%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          Hire<span className='text-primary'> Administrative Assistant</span>
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-11/12  '>
          We provide the perfect solution - a highly skilled Administrative Assistant! Delegate scheduling,
          communication, and more, freeing you to focus on growing your business. Contact us now and get connected.
        </p>
      ...
      <img src='/images/hireadministrativeassistent.png' className=' w-[40%]  flex justify-end' alt='' />
