...
export default function FsSocialMediaMarketing() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[56%]      pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Social Media</span> Marketing
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-11/12  '>
          We offer comprehensive Social Media Marketing services, strategically crafting engaging content to boost your
          online presence and drive meaningful connections with your audience.
        </p>
      ...
      <img src='/images/socialmediamarketing.png' className=' w-[40%]  flex justify-end' alt='' />
