...
export default function FsHireAdministrativeSpecialist() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[56%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          Hire<span className='text-primary'> Administrative Specialist</span>
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-11/12  '>
          IR Solutions provides you with highly skilled and experienced Administrative Specialists. They&apos;ll handle
          your workload, freeing you to focus on core business activities. Invest in your success, hire us today!
        </p>
      ...
      <img src='/images/hireadministrativespecialist.png' className=' w-[40%]  flex justify-end' alt='' />
