...
export default function FsUnity3dGameDev() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[56%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Unity 3D</span> Game Development Services
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-11/12   '>
          Our Unity 3D game development services use state-of-the-art technology, from development and design to
          programming. We ensure your game meets technical standards and captivating experience for your players.
        </p>
      ...
      <img src='/images/unity3dgamedev.png' className=' w-[40%]  flex justify-end' alt='' />
