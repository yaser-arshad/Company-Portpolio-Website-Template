...
export default function FsIonicAppDevServices() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[62%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Ionic</span> App Development
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-3/4  '>
          Enhance your business operations by creating sophisticated Ionic apps. Optimize your business workflows by
          constructing advanced applications utilizing Ionic app development.
        </p>
      ...
      <img src='/images/ionicappdevservices.png' className=' w-[38%]  flex justify-end' alt='' />
