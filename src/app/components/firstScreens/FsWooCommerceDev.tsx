...
export default function FsWooCommerceDev() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className='w-[56%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>WooCommerce</span> Development Services
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7  w-[91%]  '>
          Our WooCommerce Development Services are tailored to your unique needs, ensuring a powerful and scalable
          online store. Boost sales and enhance brand visibility with our expertise in the competitive e-commerce
          landscape.
        </p>
      ...
      <img src='/images/woocommercedev.png' className='w-[40%]  flex justify-end' alt='' />
