...
export default function FsUbercartDev() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[56%]   pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Ubercart</span> Development Services
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-[91%] '>
          Our team specializes in Ubercart services, crafting flexible, customizable online stores tailored to your
          business needs. Let&apos;s build your perfect platform.
        </p>
      ...
      <img src='/images/ubercartdev.png' className=' w-[40%]  flex justify-end' alt='' />
