...
export default function FsCakePhpWebDev() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[56%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Cake PHP</span> Web Development Services
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-[91%]  '>
          IR Solutions, a top CakePHP Development Company, offers diverse CakePHP services for global business
          expansion. Our dedicated CakePHP developers ensure services meet your standards.
        </p>
      ...
      <img src='/images/cakephpwebdev.png' className='absolute bottom-0' alt='' />
      </div>
