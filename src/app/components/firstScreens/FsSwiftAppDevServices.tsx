...
export default function FsSwiftAppDevServices() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[56%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Swift</span> App Development
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-[91%]  '>
          Enhance your business operations by creating sophisticated Swift apps. Optimize your business workflows by
          constructing advanced applications utilizing Swift app development.
        </p>
      ...
      <img src='/images/swiftappdevservices.png' className=' w-[40%]  flex justify-end' alt='' />
