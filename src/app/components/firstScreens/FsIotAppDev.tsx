...
export default function FsIotAppDev() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[56%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>IOT App</span> Development Services
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-11/12  '>
          Our IoT app development services provide customized solutions for smart devices, facilitating improved
          automation across a range of sectors and applications, real-time data analytics, and seamless communication.
        </p>
      ...
      <img src='/images/iotappdev.png' className=' w-[41%]  flex justify-end' alt='' />
