...
export default function FsIotDashboardAnalytics() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[56%]      pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Iot</span> Dashboard & Analytics Services
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-11/12  '>
          Our IoT Dashboard & Analytics solutions offer advanced data visualization, insights, and control, enabling
          smarter decisions and proactive management.
        </p>
      ...
      <img src='/images/iotdashboardanalytics.png' className='   flex justify-end' alt='' />
