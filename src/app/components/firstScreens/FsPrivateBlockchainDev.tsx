...
export default function FsPrivateBlockchainDev() {
  return (
    <div className=' w-full flex  text-black pt-15 relative'>
      <div className=' w-[56%]    pl-14 pb-20'>
        <h2 className=' font-bold text-7.2xl leading-tight'>
          <span className='text-primary'>Private Blockchain</span> Development Services
        </h2>

        <p className=' pt-2.8  font-normal text-lg leading-7 w-11/12 '>
          Experience the Power of Privacy! Our Private Blockchain Development Services offer secure, exclusive networks
          tailored to your business. Choose us for bespoke blockchain solutions that prioritize your privacy.
        </p>
      ...
      <img src='/images/privateblockdev.png' className='   flex justify-end' alt='' />
