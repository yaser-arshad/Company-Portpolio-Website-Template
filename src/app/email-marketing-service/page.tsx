...
import FsEmailMarketing from 'app/components/firstScreens/FsEmailMarketing';
import { industriesData } from 'app/core/_data';
import { unleashGrowthData } from 'app/core/_data';

import { EmailMarketingFaqData } from 'components/layout/Footer-Components/FAQ-Data/EmailMarketingFaqData';
...
export default function page() {
  return (
    <div>
      ...
      <SuccessStories />
      <RelatedBlogs />
      <FAQs pageTitle={'FAQ'} pageSubtitle={''} faqData={EmailMarketingFaqData} />
      <Footer />
    </div>
  );
}
